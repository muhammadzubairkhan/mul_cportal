...
<head>
<meta charset="utf-8">
<title>6-Circuit Inner - Multinet</title>
    ...
    <div class="container-fluid">
        <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 header-box">
                    ...
                    <h1 class="main-title">Circuit Number: 001337-505 <span class="favorites pull-right"><i class="fa fa-star"></i> Add To Favorites</span></h1>
                    <h3 class="main-address">Suit 202 2nd Floor Abacus Building, DHA, Phase-3, Karachi, Pakistan</h3>
                    <p class="main-serive-status">SLA: 96.4% <span class="main-serive-status-active">Status: Active</span></p>
                                    ...
                                    <div class="tab-content">
                                        <div class="col-md-12">
                                            <div class="tab-pane fade active in" id="tab_2_1">
                                                ...
                                                <a href="12_create-new-complain.html" class="btn green-haze pull-right">
                                                Support
                                                </a>
                                                
                                                <a href="9_billing-all-statements-inner.html" class="btn green-haze pull-right">
                                                Invoice
                                                </a>
                                            ...
                                            <div class="tab-pane fade active in" id="tab_2_1">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3 no-left-margin">
                                                        ...
                                                        <span class="title-data">0021347-99866</span>
                                                    </div>

                                                    <div class="col-md-3">
                                                        <span class="sub-title">BANDWIDTH</span>
                                                        <span class="title-data">1 Mbps</span>
                                                    </div>

                                                    <div class="col-md-3">
                                                        <span class="sub-title">CIRCUIT NAME</span>
                                                        <span class="title-data">MCB (Ravi Road)</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3 no-left-margin">
                                                        ...
                                                        <span class="title-data">192.168.0.12</span>
                                                    </div>
