...
<head>
<meta charset="utf-8">
<title>4-Support New Lead - Multinet</title>
                                                  ...
                                                  <div class="input-group">
                                                    ...
                                                    <span class="input-group-btn">
                                                        <div class="selectdiv">
                                                                  ...
                                                                  <asp:DropDownList CssClass="form-control" name="id" id="id" runat="server">
                                                                        <asp:ListItem Enabled="False" Selected="True" Text="Month" Value="Month" />
                                                                        <asp:ListItem Enabled="True" Selected="False" Text="January" Value="January" />
                                                    ...
                                                    <div class="selectdiv">
                                                              ...
                                                              <asp:DropDownList CssClass="form-control" name="nr" id="nr" runat="server">
