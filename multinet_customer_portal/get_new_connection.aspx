...
<head>
<meta charset="utf-8">
<title>3-Get New Connection - Multinet</title>
                                    ...
                                    <form class="login-form" action="get_new_connection.html" method="post" runat="server">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group margin-bottom-logo">
                                                ...
                                                <div class="input-icon">
                                                    <asp:TextBox CssClass="form-control placeholder-no-fix" autocomplete="off" placeholder="Primary Contact" name="primary_contact" id="primary_contact" runat="server"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group margin-bottom-logo">
                                                ...
                                                <div class="input-icon">
                                                    <asp:TextBox CssClass="form-control placeholder-no-fix" autocomplete="off" placeholder="Contact Phone" name="contact" id="contact" runat="server"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group margin-bottom-logo">
                                                ...
                                                <div class="input-icon">
                                                    <asp:TextBox CssClass="form-control placeholder-no-fix" autocomplete="off" placeholder="* Name" name="name" id="name" runat="server"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
